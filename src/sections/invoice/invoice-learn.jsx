      ...
      <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2 }}>
        ...
        <Box sx={{ flex: 1 }}>
          ...
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            ...
            <br />
            The system auto-generates invoice numbers incrementally per customer based on their
            settings. The format is always: <code>[Prefix][Current Serial Number][Suffix]</code>.
          </Typography>
        </Box>
      </Box>
    </Card>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 3 }}>
        <Box sx={{ display: 'flex', gap: 1.5 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary', fontSize: '13px' }}>
              The invoice has been generated and sent, but no payments have been recorded yet. The
              invoice is awaiting customer payment.
            </Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ display: 'flex', gap: 1.5 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary', fontSize: '13px' }}>
              The customer has paid a portion of the invoice total, but a balance is still remaining
              to be settled.
            </Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ display: 'flex', gap: 1.5 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary', fontSize: '13px' }}>
              The invoice was voided. Note: This frees up the underlying jobs/subtrips back to
              &quot;Received&quot; status so they can be billed again.
            </Typography>
          </Box>
        </Box>
      </Box>
      ...
      >
        ...
        <AccordionDetails sx={{ pt: 2 }}>
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            ...
            <code>Rate × Loading Weight</code>.
            <br />
            2. The <b>Shortage Amount</b> for that trip is kept as a separate line item deduction
            record, but it is not directly subtracted from the gross freight by default to keep the
            accounting clear.
            <br />
      ...
      >
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
            ...
            />
            <Typography variant="subtitle2">How does Tax (GST) mapping work?</Typography>
          </Box>
        </AccordionSummary>
        <AccordionDetails sx={{ pt: 2 }}>
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            Taxes are dynamically generated using your Tenant and Customer configuration mapping. If
            the Customer has <b>GST Enabled</b>, the system compares the Customer state to the
            Tenant state.
            <br />
            <br />• <b>Intra-state</b> (Same State): Applied evenly across <b>CGST</b> and{' '}
            <b>SGST</b>.
