      ...
      <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2 }}>
        ...
        <Box sx={{ flex: 1 }}>
          ...
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            A Transporter Payment Receipt is a document generated to pay third-party / market
            vehicle transporters for jobs they have completed on your behalf.
            <br />
            <br />
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 3 }}>
        <Box sx={{ display: 'flex', gap: 1.5 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary', fontSize: '13px' }}>
              The payment receipt has been finalized and recorded, but no actual payment has been
              made yet to the transporter.
            </Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ display: 'flex', gap: 1.5 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary', fontSize: '13px' }}>
              You have successfully logged the payment covering the full amount owed to the
              transporter.
            </Typography>
          </Box>
        </Box>
  ...
  const renderFAQs = (
    <Card sx={{ p: 3 }}>
      ...
      >
        ...
        <AccordionDetails sx={{ pt: 2 }}>
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            ...
            <br />
            <br />
            1. First, an <b>Effective Freight Rate</b> is determined by doing: (
            <code>Rate - Commission Rate</code>)
            <br />
            2. The <b>Total Freight</b> is calculated:{' '}
            <code>Effective Freight Rate × Loading Weight</code>.
            <br />
            3. The <b>Pre-Tax Income</b> is derived by subtracting any job expenses / toll expenses
      ...
      >
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
            ...
            />
            <Typography variant="subtitle2">How are TDS and GST calculated?</Typography>
          </Box>
        </AccordionSummary>
        <AccordionDetails sx={{ pt: 2 }}>
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            • <b>TDS</b>: Tax Deduction at Source is dynamically calculated based on the
            Transporter&apos;s <code>TDS Percentage</code> setting and applied to the Total Freight
            amount.
            <br />
            <br />• <b>GST</b>: Since transporters operate under a Reverse Charge Mechanism (RCM),{' '}
            <b>GST is NOT added to the Total Net Amount.</b> Instead, GST breakdowns are shown
            purely for your accounting references. If the Transporter has GST Enabled, the system
            will compare the Transporter State against the Tenant State to calculate CGST/SGST vs
            IGST.
          </Typography>
        </AccordionDetails>
      </Accordion>
      ...
      >
        ...
        <AccordionDetails sx={{ pt: 2 }}>
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            You cannot edit a job once it&apos;s been linked to a Transporter Payment. If you need
            to make changes:
            <br />
            <br />
      ...
      >
        ...
        <AccordionDetails sx={{ pt: 2 }}>
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            Yes! Deleting a Transporter Payment Receipt entirely wipes it strictly from your
            ledgers. This uniquely unlinks all the underlying jobs so that they may be corrected and
            re-billed with different totals. It safely nullifies the connection.
          </Typography>
        </AccordionDetails>
      </Accordion>
    </Card>
