      ...
      <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 2 }}>
        ...
        <Box sx={{ flex: 1 }}>
          ...
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            ...
            essential for trip planning, execution, and salary management. Track their license
            details, experience, contact information, and more.
          </Typography>
        </Box>
      </Box>
    </Card>
      ...
      >
        ...
        <AccordionDetails sx={{ pt: 2 }}>
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            ...
            appear in selection dropdowns. Their history and profile remain accessible for
            reference. Use this for drivers on leave or temporarily unavailable.
          </Typography>
        </AccordionDetails>
      </Accordion>
