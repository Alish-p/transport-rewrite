      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 3 }}>
        ...
        <Box sx={{ display: 'flex', gap: 1.5 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary', fontSize: '13px' }}>
              The PO has been manually closed. It is locked and no further items can be received or
              edits made, even if some items are pending.
            </Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ display: 'flex', gap: 1.5 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary', fontSize: '13px' }}>
              A reviewer has denied this purchase request. Rejected POs cannot be edited or
              received. A rejection reason may be provided.
            </Typography>
          </Box>
        </Box>
      </Box>
      ...
      >
        ...
        <AccordionDetails sx={{ pt: 2 }}>
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            ...
            (difference). Your inventory valuation (Moving Average Price) will update using the{' '}
            <b>Actual Cost</b>, not the PO cost.
            <br />
            <br />
