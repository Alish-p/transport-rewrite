    ...
    >
      <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 2 }}>
        ...
        <Box sx={{ flex: 1 }}>
          ...
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            A salary record transitions through a few life-cycles. Managing statuses helps you track
            what is due versus what is settled.
          </Typography>
        </Box>
      </Box>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 3 }}>
        <Box sx={{ display: 'flex', gap: 1.5 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary', fontSize: '13px' }}>
              The salary record is created and amounts are aggregated, but no actual payment has
              been made yet. This acts as an invoice or claim.
            </Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ display: 'flex', gap: 1.5 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary', fontSize: '13px' }}>
              Mark as paid once the payment is successfully deposited to the driver&apos;s bank
              account or handed in cash.
            </Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ display: 'flex', gap: 1.5 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary', fontSize: '13px' }}>
              If generated by mistake or with incorrect parameters, the salary can be cancelled.
              Cancelled salaries do not contribute to final ledger totals.
            </Typography>
          </Box>
        </Box>
      </Box>
      ...
      >
        ...
        <AccordionDetails sx={{ pt: 2 }}>
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            ...
            .
            <br />
            4. Any manual deductions (like advance cuts or fines) are subtracted as{' '}
            <b>Deductions</b>.
            <br />
      ...
      >
        ...
        <AccordionDetails sx={{ pt: 2 }}>
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            ...
            subtrips <b>are NOT deleted</b>, but this specific payment record vanishes. This action
            should only be taken if the entry was completely fictitious. Otherwise, prefer changing
            the status to <b>Cancelled</b> to retain an audit trail.
          </Typography>
        </AccordionDetails>
      </Accordion>
    </Card>
