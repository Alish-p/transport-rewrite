      ...
      <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 2 }}>
        ...
        <Box sx={{ flex: 1 }}>
          ...
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            Comprehensive tracking of your fleet&apos;s tyres from purchase to scrap. Manage
            lifecycle events like mounting, unmounting, and remolding to optimize cost and
            performance.
          </Typography>
        </Box>
      </Box>
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell sx={{ color: 'text.secondary', fontSize: '13px', lineHeight: 1.6 }}>
              <strong>Mount:</strong> Assigning a tyre to a specific position on a vehicle. Requires
              current odometer readings.
              <br />
              <strong>Unmount:</strong> Removing a tyre to Stock. The system calculates distance
              covered based on odometer difference.
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell sx={{ fontWeight: 600 }}>
            ...
            <TableCell sx={{ color: 'text.secondary', fontSize: '13px', lineHeight: 1.6 }}>
              ...
              <Box component="span" sx={{ display: 'block', mt: 0.5, fontStyle: 'italic' }}>
                • Updates status to <strong>Remolded</strong>
                <br />• Resets/Increases <strong>Thread Depth</strong>
                <br />• Extends usable life
              </Box>
            </TableCell>
          </TableRow>
          <TableRow>
            ...
            <TableCell sx={{ color: 'text.secondary', fontSize: '13px', lineHeight: 1.6 }}>
              The configuration of wheels (e.g., 12 Tyre, 10 Tyre). Selected in Vehicle settings.
              Determining where tyres can be mounted.
            </TableCell>
          </TableRow>
        </TableBody>
      </Table>
    ...
    <Card sx={{ p: 3 }}>
      ...
      >
        ...
        <AccordionDetails sx={{ pt: 2 }}>
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            <strong>Yes.</strong> Current KM represents the total actual accumulated mileage of the
            tyre over its entire lifespan. It includes the initial &quot;Opening KM&quot; (for used
            tyres) plus all distance covered while mounted on vehicles.
          </Typography>
        </AccordionDetails>
      </Accordion>
      ...
      >
        ...
        <AccordionDetails sx={{ pt: 2 }}>
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            Tyres mounted in the <strong>Stepney</strong> position generally{' '}
            <strong>do not accumulate mileage</strong>. When unmounted from a Stepney position, the
            system records 0 km covered for that duration, regardless of the vehicle&apos;s odometer
            change.
          </Typography>
        </AccordionDetails>
      </Accordion>
      ...
      >
        ...
        <AccordionDetails sx={{ pt: 2 }}>
          <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
            Access is restricted to authorized users with <strong>Tyre Management</strong>{' '}
            permissions. This typically includes Fleet Managers and Admins. Standard drivers or
            restricted users cannot modify tyre data.
          </Typography>
        </AccordionDetails>
      </Accordion>
    </Card>
