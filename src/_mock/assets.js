...
export const _postTitles = [
  `Revolutionizing Fleet Management: Real-Time Tracking and Efficiency`,
  `The Role of Automation in Invoice and Billing Processes`,
  `Streamlining Driver Salary Management for Logistics Businesses`,
  `Tire Management: Enhancing Safety and Reducing Costs`,
  `How Technology is Transforming Fleet Maintenance Scheduling`,
  `The Future of Fuel Monitoring in Logistics Operations`,
  `Optimizing Route Planning: A Key to Cost-Effective Transport`,
  `The Impact of Data Analytics on Logistics Decision-Making`,
  `Smart Warehousing: Integrating AI for Better Inventory Management`,
  `Sustainable Logistics: Strategies for Greener Operations`,
  `Customizable Solutions for Smarter Transport Management`,
  `The Importance of Real-Time Communication in Fleet Operations`,
  `Predictive Maintenance: A Game-Changer for Logistics Efficiency`,
  `Digital Transformation in Logistics: Key Trends and Benefits`,
  `Overcoming Challenges in Cross-Border Transportation`,
  `The Evolution of Logistics Management Software`,
  `Enhancing Customer Experience through Advanced Tracking Systems`,
  `The Environmental Benefits of Efficient Transport Planning`,
  `Integrating IoT into Fleet and Logistics Management`,
  `The Role of Minimal Design Systems in Modern Logistics Solutions`,
];
...
export const _sentences = [
  `Real-time tracking ensures seamless fleet management and efficient route optimization.`,
  `The automated invoice generator simplifies billing processes, reducing errors and saving time.`,
  `Drivers appreciate the easy-to-use salary management system, ensuring accurate and timely payments.`,
  `Regular tire maintenance improves safety and reduces operational costs for logistics companies.`,
  `Fuel monitoring systems optimize consumption, cutting costs and enhancing sustainability.`,
  `Smart scheduling tools help manage fleet maintenance, minimizing downtime and improving efficiency.`,
  `Advanced analytics offer actionable insights to make data-driven logistics decisions.`,
  `Customizable transport solutions adapt to unique business needs, streamlining operations.`,
  `Predictive maintenance technology prevents breakdowns, ensuring smooth logistics operations.`,
  `IoT integration enhances fleet visibility, improving overall operational control.`,
  `Sustainable logistics practices help reduce environmental impact while maintaining efficiency.`,
  `The dashboard provides real-time updates, keeping logistics teams informed and proactive.`,
  `Route optimization software minimizes delivery time and fuel consumption, boosting efficiency.`,
  `Effective tire management systems track performance and replacement schedules for cost savings.`,
  `The minimal design system ensures intuitive navigation and a user-friendly experience.`,
